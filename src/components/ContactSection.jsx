            ...
            <div className='row'>
                <div className='col-md-6 d-flex flex-column justify-content-center'>
                    ...
                    <ul className='list-unstyled d-flex justify-content-center'>
                        <li>
                            <a href="https://www.linkedin.com/in/harmanpreet-deo">
                        ...
                        <li className='mx-3'>
                            <a href="https://github.com/deoHRMN">
                        ...
                        <li>
                            <a href="https://www.facebook.com/profile.php?id=100074772137394&mibextid=kFxxJD">
